...
description: Challenge academic content with 5-7 specific pedagogical questions. Checks ordering, prerequisites, gaps, alternatives, notation conflicts, cognitive load, and standalone readiness. Works on slides, lecture notes, paper drafts, and assignments.
disable-model-invocation: true
argument-hint: "[filename or topic description]"
---

# Devil's Advocate Review

Critically examine academic content (slides, notes, paper drafts, assignments) and challenge its design with 5-7 specific pedagogical questions.
...
2. **Read the knowledge base** in `AI Tools/claude code/rules/` for notation conventions and narrative arc
